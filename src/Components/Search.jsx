...
searchRef.current.classList.add("while-search")
  ...
  return (
      <div className='px-36 fixed bottom-0 left-0 right-0 z-50 bg-white w-full h-40 mt-10 overflow-y-hidden outline outline-1'>
          <form action="">
          ...
          <motion.div
              ...
              className='bg-[#1d3557] w-1/2 text-white dark:bg-white dark:text-[#1d3557] px-6 py-1 absolute h-20 -top-[150px] left-0 mx-auto right-0'>
